 ...
 * 
 * @Component public class AppFilter implements GlobalFilter {
 * 
 ...
 * 
 * keySet.forEach(key -> { List<String> values = headers.get(key);
 ...
 * response.setStatusCode(HttpStatus.BAD_REQUEST); Mono<Void> writeAndFlushWith
